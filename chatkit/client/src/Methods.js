...
function connectToRoom(id = 19414065) {
    ...
    axios
        ...
        .then(() => {
            ...
            const chatManager = new Chatkit.ChatManager({
                ...
                userId: "Rad",
                tokenProvider: "https://us1.pusherplatform.io/services/chatkit_token_provider/v1/9e14975c-602d-4718-8bad-ca97925e559a/token",
            });
